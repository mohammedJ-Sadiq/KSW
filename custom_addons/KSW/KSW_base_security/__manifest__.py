{
    ...
    'assets': {
        ...
        'web.assets_backend': [
            'KSW_base_security/static/src/js/report_open_inline.js',
            'KSW_base_security/static/src/js/attachment_preview.js',
            'KSW_base_security/static/src/js/attachment_preview.xml',
        ],
    },
    'installable': True,
    'application': False,
